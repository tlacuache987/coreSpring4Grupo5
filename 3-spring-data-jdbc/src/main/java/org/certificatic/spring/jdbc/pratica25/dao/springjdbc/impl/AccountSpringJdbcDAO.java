...
public class AccountSpringJdbcDAO extends GenericSpringJdbcDAO<Account, Long>
	...
	public void insert(Account entity) {
		...
		paramSource.addValue("fkCustomerId", entity.getCustomer().getId());
		paramSource.addValue("accountNumber", entity.getAccountNumber());
		paramSource.addValue("createdDate", entity.getCreatedDate());
		paramSource.addValue("balance", entity.getBalance());
	...
	public void update(Account entity) {
		...
		this.jdbcTemplate.update(UPDATE_ACCOUNT_WHERE_CUSTOMER_ID, entity.getAccountNumber(),
				entity.getCreatedDate(), entity.getBalance(), entity.getId());
	}
	...
	public Account findById(Long id) {
		...
		try {
			...
			account = this.jdbcTemplate.queryForObject(SELECT_ACCOUNT,
