...
public class PropertiesArraysListsMapsAndIndexersExpressionsTest_3 {
	...
	public static void setUp() {
		...
		societyContext = new StandardEvaluationContext(SocietyStub.createSociety("IEEE"));
	}
	...
	public void propertiesSpelTest() {
		...
		// definir y obtener el valor de la expresion "name" en el contexto
		// teslaContext
		...
		int teslaBirthYear = (int) spelParser.parseExpression("birthdate.year + 1900").getValue(teslaContext);
		// definir y obtener el valor de la expresion "birthdate.year + 1900" en
		...
		// definir y obtener el valor de la expresion "nationality" en el
	...
	public void arraysSpelTest() {
		...
		// definir expresión que corresponda con
	...
	public void listSpelTest() {
		...
		// utilizando el contexto society, obtener el
									// nombre de Tesla
		...
		String inventionName_1 = (String) spelParser.parseExpression(
				"getMembers().get(2).getInventions()[1]")
				.getValue(societyContext);
		// utilizando el contexto society,
										// obtener el nombre del invento
										// posici�n 1 del miembro posici�n 2,
		...
		// utilizando el contexto society,
											// obtener el nombre del invento
											// posici�n 1 del miembro posici�n
											// 2, obener utilizando posici�n en
											// el arreglo
	...
	public void inlineListSpelTest() {
		...
		// definir y obtener el valor de
												// una expresi�n que corresponda
												// a la definici�n de una lista
	...
	public void mapSpelTest() {
		...
		Inventor president = (Inventor) spelParser.parseExpression(
				"officers['president']").getValue(societyContext);
		...
		String presidentBornCity = null; 
		// definir y obtener el nombre de la
	...
	public void inlineMapSpelTest() {
		...
		Map<String, String> mapOfValues = (Map<String, String>) spelParser
				.parseExpression("{name:'Nikola Tesla', bornDate: '09/07/1856'}").getValue(); // s�lo
																								// analizar
		...
		String nikolaName = (String) spelParser.parseExpression("['name']").getValue(mapOfValues); // s�lo
																									// analizar
	...
	public void arrayConstructionSpelTest() {
		...
		int[] emptyIntArray = (int[]) spelParser.parseExpression("new int[4]").getValue(); // s�lo
																							// analizar
		...
		int[] intArray = (int[]) spelParser.parseExpression("new int[]{1,2,3,4,5}").getValue(); // s�lo
																								// analizar
