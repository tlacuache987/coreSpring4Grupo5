...
public class MethodExpressionsTest_4 {
	...
	public void methodExpressionsTest() {
		...
		// definir expresi�n substring que obtenga el valor esperado de Tesla
		...
		// definir expresi�n que verifique si el 'Rudolf Carl Virchow' es miebro de la sociedad IEEE
		...
		// definir expresi�n que verifique si el 'Charles Babbage' es miebro de la sociedad IEEE
